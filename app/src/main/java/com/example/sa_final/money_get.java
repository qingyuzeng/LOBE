...
public class money_get extends  AppCompatActivity  {
    private FirebaseAuth mAuth;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        setTitle("我的QRCODE");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.money_get);
        getQRCode();
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(money_get.this, Home.class);
    ...
    public void getQRCode(){
        ...
        ImageView ivCode = (ImageView) findViewById(R.id.img_qrcode);    //這行代表宣告ivCode即為介面中的imageView
