...
public class activity_list_join extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_join);
        ...
        btn_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(activity_list_join.this, Home.class);
...
//                listview.setAdapter(adapter);
    ...
    private void getInformation() {
        ...
        final FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference("join");
        myRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                adapter.clear();
                ...
                for (DataSnapshot contact : dataSnapshot.getChildren()) {
                    ...
                    Log.v("memberphone",phone);
                    String a= String.valueOf(sr1.length);
                    Log.v("memberphone",a);
                    if(sr[1].matches(sr1[1])){
                        String activityname = contact.child("activity_name").getValue(String.class);
                        String activitydate = contact.child("activity_date").getValue(String.class);
                        String activitycontent = contact.child("activity_content").getValue(String.class);
                        String activityunit=contact.child("activity_unit").getValue(String.class);
                ...
                SimpleAdapter mySimpleAdapter = new SimpleAdapter(activity_list_join.this, myArrayList,
                ...
                myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView arg0, View arg1, int arg2,
                        ...
                        Intent intent = new Intent(activity_list_join.this, activity_join_list.class);
